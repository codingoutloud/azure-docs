...
We recommend that you set up additional secure access to your key vault by [configuring Key Vault firewalls and virtual networks](network-security.md).
...
For a getting-started tutorial for an administrator, see [What is Azure Key Vault?](overview.md)).
